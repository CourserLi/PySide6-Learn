...
class ComicThread(QThread):
    ...
    def run(self):
        ...
        test.test(checkpoint_dir, style_name, test_dir, if_adjust_brightness)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        widgets.btn_start.clicked.connect(self.start_transform)
    ...
    def start_transform(self):
        """
        开始图片动漫化，转换后的图片的路径是 images/comic
        """
        self.comic_thread = ComicThread()
    ...
    def reveal_comic(self):
        ...
        url = "./images/comic/AE86.png"
        if len(os.listdir("./images/comic/")) == 0:
            QMessageBox.information(self, "提示", "目录下没有图片，请先动漫化图片", QMessageBox.Yes)
        else:
